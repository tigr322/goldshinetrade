      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="mt-8 bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100">
          ...
          <div class="mt-3 grid grid-cols-2 gap-3">
            ...
            >
              <svg class="h-5 w-5" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill="#FBBC05" d="M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78л7.97-6.19z"/>
                <path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81л-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91л-7.98 6.19C6.51 42.62 14.62 48 24 48z"/>
              </svg>
              Войти через Google
            </a>
          ...
          <form class="mt-8 space-y-6" @submit.prevent="submit">
            ...
            <PrimaryButton
              :class="['w-full justify-center h-11 rounded-xl bg-cyan-700 hover:bg-cyan-600 focus:ring-cyan-600', { 'opacity-50 cursor-not-allowed': form.processing }]"
              :disabled="form.processing"
            > 
              <svg v-if="form.processing" class="rounded-xl bg-cyan-700 px-5 py-3 text-base font-semibold text-white hover:bg-cyan-600 shadow-sm" viewBox="0 0 24 24" fill="none">

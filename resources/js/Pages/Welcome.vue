        ...
        <div class="relative px-6 lg:px-8">
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">GoldShineTrade — обменяй игровые достижения на реальные возможности!</h1>
            ...
            <Link
                ...
                <Link
                            ...
                            <Link
                            :href="route('LearnMore')" class="text-base font-semibold leading-7 text-gray-900">Узнать больше <span aria-hidden="true">→</span> </Link>
              </div>
            </div>
          </div>
